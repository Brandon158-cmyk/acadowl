...
These are non-negotiable constraints for every UI issue in this sprint. The parent portal is the most performance-sensitive surface in EduZambia — many guardians use basic Android phones on Airtel's 3G network.
...
> Mrs. Banda receives an SMS: "Kabulonga Boys School has registered you as guardian for Chanda Banda. Access your parent portal at kabulonga.eduzambia.zm. Your phone: +260971234567. Reply STOP to opt out." She opens the link, verifies her phone via OTP, and sees Chanda's dashboard.
...
A guardian with 2+ children can pay all outstanding balances in a single mobile money transaction. This is one of EduZambia's headline features for parents.
...
- [ ] SMS notification to guardian when teacher replies: "Reply from [TeacherName] about [StudentName] on EduZambia. View: [link]"
...
- [ ] SMS content: "[TeacherName] sent you a message about [StudentName] on EduZambia. View: [link]"
...
_EduZambia Development Guide — Sprint 03 — Guardian Portal & Communications_
