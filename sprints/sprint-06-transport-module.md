# EduZambia — Sprint 06: Transport Module
...
- [ ] `src/app/(driver)/manifest.json`: `{ name: "EduZambia Driver", display: "standalone", theme_color: "#1a365d", background_color: "#1a365d" }`
...
> Chanda was acting up on the bus and the driver needs to inform her parents. The driver opens EduZambia, finds Chanda's record, and sends a message: "Chanda was standing on the seat while the bus was moving today. Please speak to her about bus safety." The guardian receives an in-app notification and can reply.
...
_EduZambia Development Guide — Sprint 06 — Transport Module_
